...
export const { getProduct, addTocart, addToTotalCost, calculateTax, incrementTotalQuantity, decrementTotalQuantity, setTotalQuantityDefaulltValue, setShowModal, changeCurrency } =
