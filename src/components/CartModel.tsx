...
const CartModel = () => {
  return (
    <div
      className="w-full h-screen bg-white fixed top-16 overflow-hidden"
      ...
      <div className=" justify-between  bg-white absolute top-0 right-0 mr-24 overflow-scroll h-4/8">
        ...
        <div className="mx-2 text-sm flex justify-between ">
          <div>
            ...
            <button className="px-6 py-2 my-4 border-2 border-black text-sm">
              VIEW BAG
            </button>
          </div>
          <div>
            <p className="text-right font-semibold">$200.00</p>
            <button className="px-6 py-2 my-4 bg-green-400 text-white text-sm">
              CHECKOUT
            </button>
          </div>
        </div>
